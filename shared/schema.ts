...
export const arbitrageOpportunities = pgTable("arbitrage_opportunities", {
  ...
  buyPrice: decimal("buy_price", { precision: 30, scale: 18 }).notNull(),
  sellPrice: decimal("sell_price", { precision: 30, scale: 18 }).notNull(),
  priceDifference: decimal("price_difference", { precision: 15, scale: 6 }).notNull(),
  ...
  liquidity: decimal("liquidity", { precision: 30, scale: 6 }),
